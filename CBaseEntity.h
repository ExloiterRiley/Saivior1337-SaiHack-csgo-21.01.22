...
{
	extern DWORD			getLocalBase();
	extern DWORD			getClientState();
	...
	extern D3DXVECTOR3		getLocalVelocity();
	extern int				getLocalFlags();
	extern int				getLocalTeam();
	extern int				isLocalScoped();
	extern int				getLocalCrosshairId();
	extern int				getLocalHealth();
	extern int				getLocalActiveWeapon();
	extern float			getLocalFlashDuration();
	extern float			getLocalSpeed();
	extern float            getLocalFlashAlpha();
	extern bool				isInGame();
	extern bool				isPlayerMoving();
	extern bool				isBombPlanted();
	extern void				setLocalViewAngles(D3DXVECTOR3 angles);
	extern const char* getMapDirectory();
	extern const char* getMapName();
	extern const char* getGameDirectory();
	extern player_info_t	getPlayerName();
}

namespace Entity
{
	extern DWORD			getEntityBase(int index);
	extern DWORD			getEntityBoneMatrix(DWORD entity);
	extern D3DXVECTOR3		getEntityBonePos(DWORD entity, int boneID);
	extern D3DXVECTOR3		getEntityPos(DWORD entity);
	...
	extern bool				isEntityHasImmunity(DWORD entity);
	extern bool				isEntitySpotted(DWORD entity);
	extern bool				isEntityVisible(DWORD entity);
